...
object PrefixOpcodes {
    ...
    val notImplemented = Operation(0, 0, "BAD OPCODE", { cpu -> throw RuntimeException("BAD OPCODE") })

    val opCodes = mapOf(
            0x00 to Operation(1, 4, "NOP", Cpu::noop),
            0x01 to Operation(3, 12, "LD BC,d16", { notImplemented }),
            0x02 to Operation(1, 8, "LD (BC),A", { notImplemented }),
            0x03 to Operation(1, 8, "INC BC", { notImplemented }),
            0x04 to Operation(1, 4, "INC B", { notImplemented }),
            0x05 to Operation(1, 4, "DEC B", { notImplemented }),
            0x06 to Operation(2, 8, "LD B,d8", { notImplemented }),
            0x07 to Operation(1, 4, "RLCA", { notImplemented }),
            ...
            0x11 to Operation(3, 12, "LD DE,d16", { notImplemented }),
            ...
            0x40 to Operation(1, 4, "LD B,B", { notImplemented }),
            0x41 to Operation(1, 4, "LD B,C", { notImplemented }),
            0x42 to Operation(1, 4, "LD B,D", { notImplemented }),
            0x43 to Operation(1, 4, "LD B,E", { notImplemented }),
            0x44 to Operation(1, 4, "LD B,H", { notImplemented }),
            0x45 to Operation(1, 4, "LD B,L", { notImplemented }),
            ...
            0x7C to Operation(1, 4, "LD A,H", { notImplemented }),
